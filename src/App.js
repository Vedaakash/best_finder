...
// --- SVG Icons ---
// Using inline SVGs is best practice in single-file React apps
const SearchIcon = () => (
...
const LogoIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-green-600"><path d="M14.5 17.5c0 2.5-2 5-4.5 5s-4.5-2.5-4.5-5c0-2.5 2-5 4.5-5s4.5 2.5 4.5 5z"></path><path d="M17 8c0-2.5-2-5-4.5-5S8 5.5 8 8c0 1.5.5 2.8 1.5 3.8"></path><path d="M20 8c0-2.5-2-5-4.5-5s-4.5 2.5-4.5 5c0 .5.1 1 .2 1.5"></path><path d="M12.5 22.5c2.5-2.5 5-4.5 5-6.5 0-1.5-.5-2.8-1.5-3.8"></path><path d="M6 14c-2-1-3.5-2.5-3.5-4C2.5 7.5 4.5 5 7 5c2.5 0 4.5 2.5 4.5 5 0 .5-.1 1-.2 1.5"></path></svg>
);
...
export default function App() {
        ...
        <nav className="bg-white/80 backdrop-blur-md shadow-md fixed w-full top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center space-x-2">
                        <button onClick={() => setLoginModalOpen(true)} className="bg-transparent text-sky-600 px-4 py-2 rounded-md text-sm font-medium hover:bg-sky-100">Login</button>
                        <button onClick={() => setSignupModalOpen(true)} className="bg-sky-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-sky-600 shadow">Sign Up</button>
                    </div>
                </div>
            </div>
        </nav>
    ...
    const AuthModal = ({ type, isOpen, onClose }) => {
        ...
        const subtitle = type === 'login' ? 'Sign in to continue' : 'Get started with FreshPricer';
                    ...
                    <form>
                        {type === 'signup' && (
                            <div className="mb-4">
                                ...
                                <input className="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-sky-500" id="name" type="text" placeholder="John Doe" />
                            </div>
                        )}
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="email">Email Address</label>
                            <input className="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-sky-500" id="email" type="email" placeholder="you@example.com" />
                        </div>
                        <div className="mb-6">
                            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="password">Password</label>
                            <input className="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-sky-500" id="password" type="password" placeholder="••••••••••" />
                        </div>
                        <button className="w-full bg-sky-500 hover:bg-sky-600 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline transition-transform transform hover:scale-105" type="button">
    ...
    const HomePage = () => (
        <div className="min-h-screen flex flex-col items-center justify-center bg-sky-100 pt-16">
            <div className="text-center p-8 max-w-4xl mx-auto">
                <h1 className="text-5xl md:text-7xl font-extrabold text-gray-800 mb-4 animate-fade-in-down">
                    Find the <span className="text-sky-500">Best</span> Prices
                </h1>
                ...
                <div className="bg-white p-4 rounded-full shadow-2xl max-w-2xl w-full mx-auto animate-zoom-in">
                    <form onSubmit={handleSearch} className="flex items-center">
                        ...
                        />
                        <button type="submit" className="bg-sky-500 text-white p-3 rounded-full hover:bg-sky-600 focus:outline-none focus:ring-4 focus:ring-sky-300 transition-transform transform hover:scale-110">
                            <SearchIcon />
                        </button>
                    </form>
                </div>
    ...
    const AboutPage = () => (
        <div className="min-h-screen bg-white pt-24 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
                <h1 className="text-4xl font-extrabold text-gray-900">About FreshPricer</h1>
            ...
            <div className="max-w-4xl mx-auto mt-16 bg-gray-50 p-8 rounded-lg shadow-inner">
                ...
                <p className="text-gray-700 mb-4">
                    My name is <span className="font-bold">Veda Akash</span>, and I'm a passionate developer dedicated to building tools that solve real-world problems. FreshPricer was born from a simple idea: what if you could know the price of vegetables at different local shops before you even left the house?
                </p>
    ...
    const Footer = () => (
        <footer className="bg-gray-800 text-white py-8 mt-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <p>&copy; 2024 FreshPricer. All Rights Reserved.</p>
                <p className="text-gray-400 text-sm mt-2">Created with ❤️ by Veda Akash</p>
            </div>
        </footer>
    );
